...
const Footer = () => {
  return (
    <footer>
      ...
      >
        <h3 className="text-white font-lato font-black text-[32px] leading-[140%]">
          Feel free to contact us
        </h3>

        <div className="flex items-center justify-center space-x-5 pt-9">
      ...
      <div className="bg-black text-center">
        <p className="font-railway font-bold text-[16px] leading-[150%] py-2 text-white">
